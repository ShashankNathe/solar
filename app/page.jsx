        ...
        <section className="pt-24 pb-12 px-4">
          <div className="container mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl mb-8">
              Streamline your operations, boost sales, and grow your solar
              company with our powerful CRM solution.
            </p>
            <Link href="/login">
              <Button
                size="lg"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-sm sm:text-base">
                  Efficiently track and nurture leads through your sales
                  pipeline.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-sm sm:text-base">
                  Monitor solar installations from proposal to completion.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-lg sm:text-xl font-semibold mb-4">
        ...
        <section className="py-12 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-base sm:text-lg mb-8">
              Join thousands of solar professionals who trust our CRM to power
              their success.
            </p>
            <Link href="/login">
